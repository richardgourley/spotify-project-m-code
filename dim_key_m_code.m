let
    ...
    #"Removed Other Columns2" = Table.SelectColumns(#"Reordered Columns",{"key", "Key Name"}),
    #"Renamed Columns" = Table.RenameColumns(#"Removed Other Columns2",{{"key", "Key Number"}}),
    #"Removed Duplicates" = Table.Distinct(#"Renamed Columns", {"Key Number"})
in
    #"Removed Duplicates"